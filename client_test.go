...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Searches.Get(context.Background(), "id")
	if userAgent != fmt.Sprintf("FindAI/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	res, err := client.Searches.Get(context.Background(), "id")
	if err == nil || res != nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	res, err := client.Searches.Get(cancelCtx, "id")
	if err == nil || res != nil {
		t.Error("Expected there to be a cancel error and for the response to be nil")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		res, err := client.Searches.Get(deadlineCtx, "id")
		if err == nil || res != nil {
